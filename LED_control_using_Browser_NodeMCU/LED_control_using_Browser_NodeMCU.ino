...
const char* ssid = "Dipan_Wifi"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "dpn798520"; // Your Wifi password, in case you have open network comment the whole statement.
